...
| `src/my/` | همان اپ برای دامنهٔ `my.gas24.ir` (با `.well-known/assetlinks.json` خودش) |
...
> سورس اصلی اپ گازیوم و صفحات استانی در این مخزن نیست؛ فقط خروجی build آن‌ها هست. هر تغییری در آن‌ها باید در پروژهٔ سورس انجام و دوباره build شود.
